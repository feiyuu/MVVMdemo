package com.feiyu.mvvmdemo.domain.request;

import com.feiyu.mvvmdemo.data.bean.DownloadFile;
import com.feiyu.mvvmdemo.data.repository.DataRepository;
import com.feiyu.mvvmdemo.domain.usecase.CanBeStoppedUseCase;
